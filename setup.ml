...
(* OASIS_START *)
(* DO NOT EDIT (digest: fe4cd3212d487b4fda6e60fed9b16803) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Library to attach names and logs to Lwt threads (for\ndebug/trace/objsize)";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\157R\162\174\151\025\230\184\t\162X\020\031b8\186";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
